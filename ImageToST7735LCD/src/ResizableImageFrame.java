...
public class ResizableImageFrame {
	private int cropX;
	private int cropY;
	...
	public ResizableImageFrame(int crop_X, int crop_Y, int crop_Width, int crop_Height){
		cropX = crop_X;
		cropY = crop_Y;
